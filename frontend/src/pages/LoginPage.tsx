  ...
  return (
    <div
      style={{
        ...
        background: `radial-gradient(ellipse 80% 60% at 50% -10%, rgba(${colors.brand.primaryRgb}, 0.16), transparent),
                     radial-gradient(ellipse 60% 50% at 90% 110%, rgba(${colors.brand.gradientEndRgb}, 0.10), transparent),
                     ${colors.bg.page}`,
        position: 'relative',
        overflow: 'hidden',
      }}
